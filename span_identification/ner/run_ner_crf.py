...
from transformers.models.big_bird import BigBirdConfig, BigBirdForTokenClassification, BigBirdTokenizer
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    if False and os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        for embed in embeddings:
            ...
            # print(ner_sent_tensor)
            # print('ner_sent_arr[0]')
            # print(ner_sent_arr[0].get_device())
            # print(ner_sent_arr[0])
